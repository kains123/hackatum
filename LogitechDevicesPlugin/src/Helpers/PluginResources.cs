namespace Loupedeck.LogitechDevicesPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.LogitechDevicesPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.LogitechDevicesPlugin.Resources.Resource.txt`.
